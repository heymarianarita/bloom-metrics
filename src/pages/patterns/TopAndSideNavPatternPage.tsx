...
const TopAndSideNavPatternPage = () => {
  return (
    <div className="min-h-screen bg-docs-bg">
      <div className="bg-background border-b border-[var(--border)]">
        <div className="max-w-4xl mx-auto px-8 py-10">
          ...
          <h1 className="text-3xl font-bold text-foreground tracking-tight">Top and side navigation with single-panel layout</h1>
          <p className="text-muted-foreground mt-2 text-sm">Combines a sticky top bar (global navigation tabs, user actions) with a collapsible side navigation sidebar for section-level navigation.</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-8 py-10 space-y-10">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
            ...
            <li>Pair with a single-panel content area for focused, linear workflows within each section.</li>
            <li>Best when top bar tabs handle 3–5 primary categories and the sidebar dynamically shows sub-categories within the selected tab.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <DesignCard variant="default" className="p-5">
            <div className="flex flex-wrap gap-3">
              <Link to="/patterns/pattern-5/preview">
        ...
        <div>
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            ...
            <p><span className="font-medium text-foreground">Content Area:</span> Fills remaining space to the right of the sidebar. Scrolls independently.</p>
            <p><span className="font-medium text-foreground">Interaction:</span> Top bar tabs handle global/top-level navigation. Sidebar handles section-level navigation within the selected tab context.</p>
          </div>
        </div>
...
export default TopAndSideNavPatternPage;
