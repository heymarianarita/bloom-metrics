...
const TwoLevelMultiPanelPatternPage = () => {
  return (
    <div className="min-h-screen bg-docs-bg">
      <div className="bg-background border-b border-[var(--border)]">
        <div className="max-w-4xl mx-auto px-8 py-10">
          ...
          <h1 className="text-3xl font-bold text-foreground tracking-tight">Two-level side navigation with multi-panel layout</h1>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-8 py-10 space-y-10">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
            ...
            <li>Best for the most complex internal tools combining deep navigation with content-heavy, multi-panel views.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <DesignCard variant="default" className="p-5">
            <div className="flex flex-wrap gap-3">
              <Link to="/patterns/pattern-4b/preview">
...
export default TwoLevelMultiPanelPatternPage;
